  ...
  module Client
    ...
    class Upload
      ...
      def initialize(base_url, token, is_token_admin: false, **rest_options)
        raise Zm::Error::ZmError, 'base_url must to be present' if base_url.nil?
        ...
        @rest_connector = Zm::Connector::RestConnector.new(**rest_options) do |conn|
      ...
      def download_file(dest_file_path, file_id, type, fmt: nil)
        ...
        raise Zm::Error::RestError, 'Invalid fmt type' if type.nil? && fmt.nil?
      ...
      def download_folder(dest_file_path, folder_id, fmt: nil)
        ...
        raise Zm::Error::RestError, 'Unauthorized fmt parameter' unless AUTHORIZED_FOLDER_FMT.include?(fmt)
      ...
      def send_file(src_file_path, folder_id, fmt: nil, type: nil, resolve: nil)
        ...
        raise Zm::Error::RestError, 'Unauthorized resolve parameter' unless AUTHORIZED_RESOLVE.include?(resolve)
